...
namespace PosMaster.Dal.Interfaces
{
	public interface IReportingInterface
	{
		...
		Task<ReturnData<List<MonthSaleViewModel>>> MonthlySalesReportAsync(Guid? clientId, string instanceId = "", string dateFrom = "", string dateTo = "");
	...
	public class ReportingImplementation : IReportingInterface
	{
		...
		public async Task<ReturnData<List<MonthSaleViewModel>>> MonthlySalesReportAsync(Guid? clientId, string instanceId = "", string dateFrom = "", string dateTo = "")
		{
